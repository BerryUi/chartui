...
import 'package:chartui/src/layout/column.layout.dart';
...
class ColumnChartPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
     ...
     ColumnChartLayout layout = ColumnChartLayout(
              drawAxis: drawAxis,
              drawNet: drawNet,
              x: x,y: y,
              barWidth: barWidth,
