...
import 'package:chartui/src/painting/points.dart';
import 'package:flutter/material.dart';
import '../context/paint_contexts.dart';

class StackedLinePainting{
  ...
  StackedLinePainting({
   ...
   void paint(){
      ...
      for (int index =subLen-1;index>=0;index--) {
            ...
            final paint = Paint()..color=areaColorList[index]..style=PaintingStyle.stroke..strokeWidth=lineWidth;
            paintContext.canvas.drawPath(path,paint);

            PointDraw.instance.paint(paint:paint..color=areaColorList[index+1],points:points,radius:pointRadius,canvas:paintContext.canvas);
