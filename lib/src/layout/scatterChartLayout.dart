...
class ScatterChartLayout implements DesignLayout {
  ...
  void _drawdatapoint({required List<Offset> points}){
     for(var i =0;i<points.length;i++){
      paintContext.canvas.drawCircle(points[i],dotRadius,Paint()..color =dotColor ..strokeWidth=2.0..style=PaintingStyle.fill); 
      }
  }
